...
const { updateDream, fetchDream, currentDream } = useDreams();
...
const handleSubmit = async () => {
  ...
  try {
    ...
    error.value = e.data?.message || 'Failed to update dream';
  } finally {
    loading.value = false;
  }
};
...
// Same styles as new.vue - reusing styles
.dream-form-page {
  min-height: 100vh;
  padding: $spacing-xl;
  padding-top: 100px;
